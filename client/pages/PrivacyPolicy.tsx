    ...
    <div className="min-h-screen bg-black text-gray-200 w-full">
      ...
      <div className="w-full max-w-4xl mx-auto px-6 sm:px-12 py-12">
        ...
        <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <a href="https://manoranjan.online" className="text-emerald-400 hover:underline">https://manoranjan.online</a> (the "Site") or use any of our services (collectively, the "Services").
        </p>
