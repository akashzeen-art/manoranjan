  ...
  return (
    <section className="relative py-12 md:py-20 overflow-hidden bg-zinc-950">
      <div className="absolute inset-0">
        <img src="/landscape_new_desicontent/31.png" alt="" className="w-full h-full object-cover opacity-40" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div className="flex items-center gap-3 mb-8 md:mb-10"
          ...
          <div>
            <h2 className="text-3xl md:text-5xl font-bebas font-black text-white">🎬 Trending Now</h2>
            <p className="text-gray-400 text-xs sm:text-sm mt-1">Most watched titles this week</p>
            <div className="w-16 h-1 bg-emerald-500 rounded-full mt-1" />
          </div>
        </motion.div>
              ...
              <motion.div key={i}
                ...
                <div className="relative h-44 sm:h-60 md:h-72 rounded-xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                    <div className="w-12 h-12 rounded-full bg-emerald-500/80 flex items-center justify-center shadow-lg shadow-emerald-500/50">
