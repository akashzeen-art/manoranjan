// WellnessCollectionSection — same grid layout as UniverseSection, yoga & cooking content
...
export function WellnessCollectionSection() {
  ...
  const BG = '/Yoga landscape/F7.png';
  ...
  return (
    <section className="relative w-full bg-black overflow-hidden py-16 sm:py-24">
      ...
      <div className="absolute inset-0 bg-cover bg-center opacity-50"
        style={{ backgroundImage: `url(/landscape_new_desicontent/39.png)` }} />
